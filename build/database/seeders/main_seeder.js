...
const createStudents = async (school, classs) => {
...
const createStudentsForClasses = async (school, classes) => {
    const students = [];
...
const createStaffs = async (school) => {
...
const createAttendanceForStudents = async (students) => {
...
const attachRoleToTeachers = async (school, schoolTeachers) => {
    const classes = [];
