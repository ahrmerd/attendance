          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  A bar chart showing student enrollment over the last 6 months.
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  A line chart showing class attendance over the last 6 months.
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <TabsContent value="students">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Fill out the form to add a new student to the school.
                  </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <TabsContent value="classes">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Fill out the form to add a new class to the school.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <form className="grid gap-4">
            ...
            <TabsContent value="guardians">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Fill out the form to add a new guardian to the school.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <form className="grid gap-4">
            ...
            <TabsContent value="teachers">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Fill out the form to add a new teacher to the school.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <form className="grid gap-4">
